...
```ini
STRIPE_KEY=pk_test_51RcGuYQ2TRPhIB8unhXTEGPd9z3bsDBkyjYZSuLF2jO...
STRIPE_SECRET=sk_test_51RcGuYQ2TRPhIB8uF0C3qJV2KqsY2ONqBXO5xwMl...
```
...
```bash
stripe login --api-key sk_test_51RcGuYQ2TRPhIB8uF0C3qJV2KqsY2ONqBXO5x...
```
